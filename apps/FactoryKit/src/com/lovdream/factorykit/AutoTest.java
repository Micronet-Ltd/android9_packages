...
public class AutoTest extends Fragment implements TestItemBase.TestCallback{
    ...
    private String[] notRunOnDevType2 = {"flash_light", "distance_sensor", "noise_mic", "key_test", "button_light", "back_led", "headset_test_nuno", "compass", "lcd_test", "tp_test"};
    private String[] notRunOnDevType3 = {"flash_light", "distance_sensor", "noise_mic", "key_test", "button_light", "back_led", "headset_test_nuno", "sim_test", "compass", "lcd_test", "tp_test"};
