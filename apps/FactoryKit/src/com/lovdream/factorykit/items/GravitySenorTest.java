					...
					public void run() {
						...
						if (errorCode == 0){
							mHandler.post(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(getActivity(),R.string.calibration_success,Toast.LENGTH_LONG).show();
								}
							});
						}else {
							mHandler.post(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(getActivity(),R.string.calibration_failed,Toast.LENGTH_LONG).show();
								}
							});
						}
					}
