...
public class VUMeter extends View {
    ...
    static final int MAX_AMPLITUDE = 4200;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mController != null)
            angle += (MAX_ANGLE - MIN_ANGLE) * mController.getMaxAmplitude() / MAX_AMPLITUDE;
        ...
        if (mController != null && mController.state() == RECORDING_STATE)
