...
public class Recerver extends Activity {

    String mAudiofilePath;
    static String TAG = "Recerver";
...
//            showWarningDialog(getString(R.string.please_insert_headset));
    ...
    void showWarningDialog(String title) {
        ...
        new AlertDialog.Builder(Recerver.this).setTitle(title)
    ...
    void showConfirmDialog() {
        ...
        new AlertDialog.Builder(Recerver.this)
        		.setCancelable(false)
