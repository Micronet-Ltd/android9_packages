...
public class TouchTest2 extends Activity {
	...
	class TouchView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			Path path = mPath;
			Paint paint1 = TouchTest2.mPaint;
		...
		public boolean onTouchEvent(MotionEvent motionevent) {
			float f;
			float f1;
			int i = TouchTest2.screen_X;
			int j = TouchTest2.screen_Y;
			f = motionevent.getX();
			f1 = motionevent.getY();
...
//				invalidate();
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(touchview);
                touchview.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN/*SYSTEM_UI_FLAG_IMMERSIVE_GESTURE_ISOLATED*/);
		mPaint = new Paint();
