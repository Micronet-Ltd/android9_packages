...
public class FlashTestFront extends Activity {
...
//    private Parameters mParameters = null;
	...
	private void enableFlash(boolean state){
		try {
			 cameraManager.setTorchMode("1", state);
		} catch (Exception e) {
	...
	private void setLEDStatus(boolean status) {
	 ...
	 File file = new File("sys/class/leds/led:torch_0/brightness");
	 File file1 = new File("sys/class/leds/led:switch/brightness");
